...
// :NOTE: константы принято называть капсом, например, BLOCK_SIZE

public class MyScanner {
    // :NOTE: лучше использовать флаги с говорящими названиями, а не -1 и -2
    int countCharacter = -1;
    boolean closeScanner = false; 
    int l = 0;
    private final int BLOCK_SIZE = 256;
    // :NOTE: вынести константу
